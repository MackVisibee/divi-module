 ...
 * @since 1.0.0
 */
class OurTeam_Parent extends ET_Builder_Module {
	// Module slug (also used as shortcode tag)
	public $slug       = 'our_team_parent';

	// Full Visual Builder support
	public $vb_support = 'on';

	// Module item's slug
	public $child_slug = 'our_team_parent_child';
	...
	/*function get_main_tabs() {
		$tabs = array(
			...
			'back'  => esc_html__( 'Arrière', 'our-team' ),
	...
	function init() {
		// Module name
		$this->name = esc_html__( 'Our Team', 'our-team' );
		...
		/*$this->settings_modal_toggles  = array(
			'general'  => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Texte avant', 'our-team' ),
				),
			),
		);*/
	}
	...
	/*function get_fields() {
		return array(
			'title' => array(
				...
				'description'     => esc_html__( 'Text entered here will appear as title.', 'our-team' ),
