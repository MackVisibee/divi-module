...
class OurTeamChild extends Component {

  static slug = 'our_team_parent_child';
...
/**
  ...
  resizeFlipBox() {
    ...
    $( '.et_pb_row' ).each( function() {
      ...
      var flixboxModulesChilds = $( this ).find( '.our_team_parent_child > div:first-child' );

      var elementHeights = $( flixboxModulesChilds ).map( function() {
        return $( this ).outerHeight();
      }).get();

      var flixboxModules = $( this ).find( '.our_team_parent_child, .mc_et_pb_flipbox' );
  ...
  render() {
    ...
    $( '.our_team_parent_child' ).removeClass( 'hidden' );

    $( currentEditing ).siblings( '.our_team_parent_child' ).removeClass( 'visible' );
    $( currentEditing ).siblings( '.our_team_parent_child' ).addClass( 'hidden' );
